...
ctx.fillText("40423127",(canvas.width)/2-60,(canvas.height)/2-25)
ctx.stroke()
...
ctx.font = "30px ScriptS"
ctx.fillText("40423127",(canvas.width)/2-60,(canvas.height)/2+200)
ctx.stroke()
...
<iframe src="./../data/gear.png" width="1000" height="1000"></iframe >